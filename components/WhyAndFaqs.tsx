...
export default function WhyAndFaqs() {
  ...
  const loadTestimonials = async (mounted: boolean) => {
    ...
    try {
      ...
      const res = await fetch(
        "https://dashboard.talaaljazeera.com/api/v1/testimonials",
        {
          method: "GET",
          headers: { Accept: "application/json" },
          cache: "no-store",
    ...
    return (
      <div className="flex items-center gap-1">
        {Array.from({ length: 5 }).map((_, i) => (
          <span
            key={i}
            className={`text-sm ${i < full ? "text-amber-500" : "text-slate-200"}`}
          >
            ★
          </span>
        ))}
  ...
  return (
    <div className="flex flex-col gap-10">
          ...
          <div className="flex items-end justify-between gap-6 flex-wrap">
            <div>
              ...
              <p className="mt-2 text-white/80 text-sm md:text-base max-w-2xl">
                بخبرة ممتدة لعقدان من التميز جعلتنا نعتني بأدق التفاصيل اللتي
                تهمكم و نبتكر لكم تجربة شراء استثنائية تليق بكم.
              </p>
            </div>
              ...
              {faqs.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span className="font-extrabold text-[#14213d]">
                        {item.question}
                      </span>
      ...
      {/* ✅ Testimonials - 4 آراء ثابتة من مصر */}
      {(() => {
        const fixedTestimonials = [
          {
            ...
            rating: 5,
            review:
              "تجربة ممتازة جدًا، جودة الطباعة كانت أعلى من المتوقع والتسليم تم في المعاد المتفق عليه. أنصح بالتعامل معاهم.",
            avatar: "",
          },
          {
            id: 2,
            ...
            rating: 5,
            review:
              "الخدمة كانت محترمة وسريعة، والتصميم طلع شيك جدًا. فريق الدعم ساعدني في كل التفاصيل لحد ما الطلب وصل.",
            avatar: "",
          },
          {
            id: 3,
            ...
            rating: 5,
            review:
              "طلبت كمية كبيرة وكانت النتيجة ممتازة. الخامات كويسة جدًا والسعر مناسب مقارنة بالجودة.",
            avatar: "",
          },
          {
            id: 4,
            ...
            rating: 5,
            review:
              "من أفضل التجارب اللي اتعاملت معاها أونلاين. سهولة في الطلب، متابعة كويسة، وجودة المنتج ممتازة.",
            avatar: "",
          },
        ];
          ...
          <section className="rounded-3xl border border-slate-100 bg-white shadow-sm overflow-hidden">
            <div className="p-6 md:p-10 relative">
              ...
              <div className="relative">
                ...
                <p className="mt-2 text-slate-600 text-sm md:text-base max-w-2xl">
                  بعض من تقييمات عملائنا في مصر اللي نفخر بيها 💛
                </p>
                          ...
                          <div className="md:rounded-2xl rounded-lg border border-slate-100 bg-white/80 backdrop-blur p-6 shadow-sm hover:shadow-md transition h-full flex flex-col">
                            ...
                            <div className="mt-5 flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <p className="font-extrabold text-[#14213d]">
                                    {t.name}
                                  </p>
